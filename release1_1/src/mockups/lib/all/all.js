...
hs.filter.ViewspecConstants={DEFAULT_VIEWSPECS:"hjmpuwyACHJLP",MAX_LEVEL_CLIPPING:63,MAX_LINE_CLIPPING:63,DEFAULT_LEVEL_CLIPPING:1,DEFAULT_LINE_CLIPPING:1,LEFT:"left",RIGHT:"right",SHOW_NODE_ID:"id",SHOW_NODE_NUMBER:"number",BRANCH_ONLY:"branch",PLEX_ONLY:"plex",NO_STRUCTURAL_CLIPPING:"none",NO_FILTERING:"none",FILTER_ALL:"all",NEXT_FILTERED_NODE:"next_node",INDENT_ON:"on",INDENT_OFF:"off",INDENT_TO_CONTENT:"to_context_node",NO_PLEX_PARENT:"none"};
...
var _aa5=dojo.dom.innerXML(this.renderedHtmlDom);
_aa5=_aa5.replace(/&lt;/g,"<");
_aa5=_aa5.replace(/&gt;/g,">");
_aa5=_aa5.replace(/&amp;/g,"&");
_aa5=_aa5.replace(/&quot;/g,"\"");
var _aa6=document.createElement("div");
_aa6.style.position="absolute";
_aa6.style.top="10px";
_aa6.style.left="10px";
_aa6.style.zIndex="9000";
_aa6.style.width="1000px";
_aa6.style.height="600px";
var _aa7=document.createElement("textarea");
_aa7.style.width="100%";
_aa7.style.height="100%";
_aa7.value=_aa5;
_aa6.appendChild(_aa7);
var _aa8=document.createElement("button");
_aa8.appendChild(document.createTextNode("Close"));
_aa8.style.display="block";
_aa8.style.topMargin="2em";
_aa6.appendChild(_aa8);
_aa8.onclick=function(){
_aa6.parentNode.removeChild(_aa6);
_aa6=null;
};
document.getElementsByTagName("body")[0].appendChild(_aa6);
}});
...
dojo.raise("string positioning not implemented");
},getLink:function(_aaf){
var _ab0=/<\s*a\s*href\s*=\s*(?:\"|\')([^\'\"]*)(?:\"|\')\s*>/igm;
var _ab1=null;
RegExp.lastIndex=0;
_ab0.lastIndex=0;
for(var i=0;i<_aaf;i++){
_ab1=_ab0.exec(this._node.data);
}
if(_ab1==null||_ab1.length!=2){
throw new hs.exception.InvalidAddress("Can not jump to link: "+_aaf);
}
var link=_ab1[1];
return link;
},getAnchor:function(){
...
hs.commands={jumpItem:function(_ab4,_ab5,_ab6,_ab7){
if(_ab7!=null&&typeof _ab7!="undefined"){
var url="#:"+_ab7;
var _ab9=new hs.address.Address(url);
var _aba=_ab9.viewspecs;
for(var i=0;i<_aba.length;i++){
_ab5.viewspecs[_ab5.viewspecs.length]=_aba[i];
}
}
var _abc=function(_abd,doc,_abf){
if(_abf!=null&&dojo.lang.isUndefined(_abf)==false){
_ab4.call(null,_abd,doc,_abf);
return;
}
doc.render();
_ab4.call(null,_abd,doc,_abf);
};
_ab5.resolve(_abc,true,_ab6);
},jumpFile:function(_ac0,_ac1,_ac2,_ac3,_ac4){
var url;
if(dojo.string.startsWith(_ac3,"./")||dojo.string.startsWith(_ac3,"../")||dojo.string.startsWith(_ac3,"/")){
url=_ac3;
}else{
url="./"+_ac3;
}
if(_ac4!=null&&dojo.string.trim(_ac4)!=""){
url+="#:"+_ac4;
}
var _ac6=new hs.address.Address(url);
hs.commands.jumpItem(_ac0,_ac6,_ac2);
},jumpOrigin:function(_ac7,_ac8,_ac9,_aca){
hs.commands._jumpRelative(hs.address.Relative.ORIGIN,_ac7,_ac8,_ac9,_aca);
},jumpEndBranch:function(_acb,_acc,_acd,_ace){
hs.commands._jumpRelative(hs.address.Relative.BRANCH_END,_acb,_acc,_acd,_ace);
},jumpEndPlex:function(_acf,_ad0,_ad1){
dojo.raise("jumping to the end of a plex with command bar not implemented");
},jumpNext:function(_ad2,_ad3,_ad4,_ad5){
hs.commands._jumpRelative(hs.address.Relative.NODE_NEXT,_ad2,_ad3,_ad4,_ad5);
},jumpBack:function(_ad6,_ad7,_ad8,_ad9){
hs.commands._jumpRelative(hs.address.Relative.NODE_BACK,_ad6,_ad7,_ad8,_ad9);
},jumpSuccessor:function(_ada,_adb,_adc,_add){
hs.commands._jumpRelative(hs.address.Relative.NODE_SUCCESSOR,_ada,_adb,_adc,_add);
},jumpPredecessor:function(_ade,_adf,_ae0,_ae1){
hs.commands._jumpRelative(hs.address.Relative.NODE_PREDECESSOR,_ade,_adf,_ae0,_ae1);
},jumpUp:function(_ae2,_ae3,_ae4,_ae5){
hs.commands._jumpRelative(hs.address.Relative.NODE_UP,_ae2,_ae3,_ae4,_ae5);
},jumpDown:function(_ae6,_ae7,_ae8,_ae9){
hs.commands._jumpRelative(hs.address.Relative.NODE_DOWN,_ae6,_ae7,_ae8,_ae9);
},jumpHead:function(_aea,_aeb,_aec,_aed){
hs.commands._jumpRelative(hs.address.Relative.PLEX_HEAD,_aea,_aeb,_aec,_aed);
},jumpTail:function(_aee,_aef,_af0,_af1){
hs.commands._jumpRelative(hs.address.Relative.PLEX_TAIL,_aee,_aef,_af0,_af1);
},jumpLink:function(_af2,_af3,_af4,_af5){
if(typeof _af5!="undefined"&&_af5!=null){
_af3=new hs.address.Address(_af5);
}
hs.commands.jumpItem(_af2,_af3,_af4);
},jumpLabel:function(_af6,_af7,_af8,_af9,_afa,_afb){
var url="#";
if(_afb==hs.commands.JumpConstants.FIRST){
url+=_af9;
}else{
if(_afb==hs.commands.JumpConstants.NEXT){
url+="*"+_af9;
}
}
if(_afa!=null&&typeof _afa!="undefined"){
url+=":"+_afa;
}
_af7=new hs.address.Address(url);
hs.commands.jumpItem(_af6,_af7,_af8,null);
},jumpContent:function(_afd,_afe,_aff,_b00,_b01,_b02){
if(_aff==null||typeof _aff=="undefined"){
throw new hs.exception.Jump("Programming error: "+"You must provide "+"'relativeTo' to "+"hs.commands.jumpWord");
}
var doc=_aff;
doc.jumpContent(_b00,_b02);
_afe=new hs.address.Address("./");
hs.commands.jumpItem(_afd,_afe,_aff,_b01);
},jumpWord:function(_b04,_b05,_b06,_b07,_b08,_b09){
if(_b06==null||typeof _b06=="undefined"){
throw new hs.exception.Jump("Programming error: "+"You must provide "+"'relativeTo' to "+"hs.commands.jumpWord");
}
var doc=_b06;
doc.jumpWord(_b07,_b09);
_b05=new hs.address.Address("./");
hs.commands.jumpItem(_b04,_b05,_b06,_b08);
},setViewspecs:function(_b0b,_b0c,_b0d,_b0e){
var url="#:"+_b0e;
_b0c=new hs.address.Address(url);
hs.commands.jumpItem(_b0b,_b0c,_b0d);
},resetViewspecs:function(_b10,_b11,_b12){
var url="#:"+hs.filter.ViewspecConstants.DEFAULT_VIEWSPECS;
_b11=new hs.address.Address(url);
hs.commands.jumpItem(_b10,_b11,_b12);
},_jumpRelative:function(_b14,_b15,_b16,_b17,_b18){
var _b19=new hs.address.Relative(_b14);
_b16.nodeAddresses[_b16.nodeAddresses.length]=_b19;
if(_b18!=null&&typeof _b18!="undefined"){
var _b1a="#:"+_b18;
var _b1b=new hs.address.Address(_b1a);
var _b1c=_b1b.viewspecs;
for(var i=0;i<_b1c.length;i++){
_b16.viewspecs[_b16.viewspecs.length]=_b1c[i];
}
}
hs.commands.jumpItem(_b15,_b16,_b17);
}};
...
_b1e[name].end=null;
_b1e[name].start=new Date();
};
this.end=function(name){
var ed=new Date();
if((_b1e[name])&&(_b1e[name]["start"])){
with(_b1e[name]){
end=ed;
total+=(end-start);
start=null;
...
var _b26=hdr.insertRow(0);
var cols=["Identifier","Calls","Total","Avg"];
for(var x=0;x<cols.length;x++){
var ntd=_b26.insertCell(x);
with(ntd.style){
...
var _b30=dojo.byId("docWindow");
hs.ui.currentRenderedDoc=new hs.ui.RenderedDocument(_b30);
hs.ui.commandBar=new hs.ui.CommandBar();
var _b31=dojo.widget.byId("hsToolbar");
_b31.initializeTurboModeSettings();
...
var _b33=hs.ui.addressResolved;
var _b34=hs.ui._addr;
var _b35=hs.ui.currentHyDoc;
hs.commands.jumpItem(_b33,_b34,_b35);
}
catch(exp){
hs.ui.reportError(exp);
}
},addressResolved:function(_b36,doc,_b38){
...
if(typeof _b38.name!="undefined"&&typeof _b38.message!="undefined"){
_b38=_b38.name+": "+_b38.message;
}
var url=_b36.fileInfo.toString();
var _b3a="Invalid HyperScope address given on URL: "+_b38+"; press enter to load "+"URL without address portion";
alert(_b3a);
hs.ui.resolveLocation(url);
}else{
hs.ui.reportError(_b38);
}
return;
}
hs.ui.currentHyDoc=doc;
var _b3b=doc.address.toString();
dojo.byId("current-link").setAttribute("href",_b3b);
var _b3c=dojo.widget.byId("viewspecsOverlay");
if(_b3c.isShowing()==true){
_b3c.reset();
}
hs.ui.currentRenderedDoc.write(hs.ui.currentHyDoc);
},printStatus:function(msg,_b3e){
this.clearStatus();
var _b3f=dojo.byId("statusArea");
_b3f.style.display="block";
_b3f.innerHTML=msg;
...
var _b40=dojo.byId("statusArea");
_b40.style.display="none";
_b40.innerHTML="";
},fadeStatus:function(){
var _b41=dojo.byId("statusArea");
if(_b41.style.display=="none"){
return;
}
var anim=dojo.lfx.html.fadeOut(_b41,700,false,function(){
hs.ui.clearStatus();
_b41.style.filter="alpha(opacity=100)";
_b41.style.opacity="1";
});
anim.play();
},reportError:function(msg){
if(typeof msg.name!="undefined"&&typeof msg.message!="undefined"){
...
if(djConfig.profiling==true){
var _b44=new Date().getTime();
hs.profile.end("programtime");
hs.profile.dump(true);
if(hs.ui._reportDocTime==true){
var _b45=window.parent.docStartTime;
var _b46=_b44-_b45;
var _b47=document.createElement("div");
_b47.innerHTML="<div id=\"docProfile\">"+"total time for everything = "+_b46+" ms"+"</div>";
dojo.html.body().appendChild(_b47);
...
var _b48=window.location.toString();
if(hs.ui._currentLocation!=_b48){
hs.ui._currentLocation=_b48;
hs.ui.resolveLocation(hs.ui._currentLocation);
}
...
hs.ui.RenderedDocument=function(_b4b){
...
var _b4d="number"+this._contextNodeNumber;
var ctxt=this._iframeDoc.getElementById(_b4d);
...
},displayDocument:function(_b4f){
this._contextNodeNumber=_b4f;
...
},_onFinishedWriting:function(_b50,_b51){
hs.ui.commandBar._onRenderedDocument(_b51);
hs.ui.dumpProfiling();
...
var _b58;
var _b59;
var _b5a=tg.parentNode;
while(_b5a!=null&&_b5a.nodeName.toLowerCase()!="tr"){
_b5a=_b5a.parentNode;
}
var _b5b=_b5a.getAttribute(hs.model.Document.HS_INTERNAL_NAMESPACE_PREFIX+":number");
...
_b58=_b5b.substring(0,_b5b.length-1);
}
}
}else{
...
var _b60=this.height+50;
var _b61=this.width;
this.viewOverlayPane.style.width=_b61+"px";
this.viewOverlayPane.style.height=_b60+"px";
this._lessModeHeight=_b60;
},isShowing:function(){
var _b62=dojo.widget.byId(this.widgetId+"Pane");
if(dojo.html.hasClass(_b62.domNode,"initial-overlay-state")){
return false;
}else{
return _b62.isShowing();
}
},reset:function(){
this._handleReset();
},show:function(){
...
var _b64=dojo.widget.byId(this.widgetId+"Pane");
_b64.bringToTop();
dojo.html.removeClass(_b64.domNode,"initial-overlay-state");
var _b65=dojo.byId("toolbarViewspecsButton");
var _b66=dojo.html.getOuterWidth(_b65);
var _b67=dojo.html.getViewportWidth();
var _b68=dojo.style.getAbsoluteY(_b65,false)+_b66/2;
var _b69=dojo.html.getOuterHeight(dojo.byId("toolbar"));
var endY=_b69+35;
if(dojo.render.html.ie!=true){
dojo.style.setOpacity(_b64.domNode,0);
}
dojo.style.show(_b64.domNode);
var _b6b=new Array();
if(dojo.render.html.ie!=true){
_b6b.push({property:"opacity",start:0,end:1});
}
_b6b.push({property:"right",start:40,end:40});
_b6b.push({property:"top",start:_b68,end:endY});
var anim=dojo.lfx.propertyAnimation(_b64.domNode,_b6b,250);
dojo.event.connect(anim,"onEnd",dojo.lang.hitch(this,function(){
this.selectedViewspecs.select();
}));
anim.play();
},hide:function(){
var _b6d=dojo.widget.byId(this.widgetId+"Pane");
var _b6e=dojo.html.getViewportWidth();
var _b6f=dojo.html.getOuterHeight(dojo.byId("toolbar"));
var _b70=_b6f+35;
var _b71=dojo.byId("toolbarViewspecsButton");
var _b72=dojo.html.getOuterWidth(_b71);
var endY=dojo.style.getAbsoluteY(_b71,false)+_b72/2;
var _b74=new Array();
if(dojo.render.html.ie!=true){
_b74.push({property:"opacity",start:1,end:0});
}
_b74.push({property:"right",start:40,end:40});
_b74.push({property:"top",start:_b70,end:endY});
var anim=dojo.lfx.propertyAnimation(_b6d.domNode,_b74,250);
dojo.event.connect(anim,"onEnd",function(){
dojo.style.hide(_b6d.domNode);
});
anim.play();
...
this._printSelectedViewspecs();
var _b76=this.selectedViewspecs.value;
var url="#:"+_b76;
if(this.applyFilter.checked==true){
var _b78=this.filterInput.value;
if(dojo.string.startsWith(_b78,"\"")==false&&dojo.string.startsWith(_b78,"/")==false){
_b78="\""+_b78+"\"";
}
url+=" ;"+_b78+";";
}
...
this._outlineDirty=false;
this._applyFilterDirty=false;
},_resetViewspecs:function(_b7a){
if(_b7a.showBlankLines()){
this.showBlankLines.checked=true;
}else{
this.showBlankLines.checked=false;
}
var _b7b=_b7a.getLevelClipping();
var _b7c=_b7a.getLineClipping();
if(_b7b==1&&_b7c==1){
this._showFirstOutline();
}else{
if(_b7b==hs.filter.ViewspecConstants.MAX_LEVEL_CLIPPING&&_b7c==hs.filter.ViewspecConstants.MAX_LINE_CLIPPING){
this._showAllOutline();
}else{
this._showOutlineNumbers(_b7b,_b7c);
}
}
if(_b7a.showNodeAddressing()){
this.showNodeAddressing.checked=true;
this.placementLeft.disabled=undefined;
this.placementRight.disabled=undefined;
if(_b7a.getNodeAddressingPlacement()==hs.filter.ViewspecConstants.LEFT){
...
if(_b7a.runSequenceGenerators()){
this.includesOn.checked=true;
}else{
this.includesOn.checked=false;
}
if(_b7a.getContentFilterType()==hs.filter.ViewspecConstants.NO_FILTERING){
this.applyFilter.checked=false;
this.filterInput.disabled=true;
}else{
if(_b7a.getContentFilterType()==hs.filter.ViewspecConstants.FILTER_ALL){
this.applyFilter.checked=true;
this.filterInput.disabled=undefined;
var _b7d=hs.ui.currentHyDoc.address.contentFilter;
if(_b7d!=null){
this.filterInput.value=_b7d.toString();
}
}else{
if(_b7a.getContentFilterType()==hs.filter.ViewspecConstants.NEXT_FILTERED_NODE){
this.applyFilter.checked=false;
this.filterInput.disabled=true;
}
}
...
},_showOutlineNumbers:function(_b80,_b81){
this.showFirstOutline.checked=false;
this.showAllOutline.checked=false;
this.levelInput.value=_b80;
this.lineInput.value=_b81;
this.levelUp.disabled=undefined;
this.levelDown.disabled=undefined;
if(_b80==hs.filter.ViewspecConstants.MAX_LEVEL_CLIPPING){
this.levelUp.disabled=true;
}
if(_b81==hs.filter.ViewspecConstants.MAX_LINE_CLIPPING){
this.lineUp.disabled=true;
}
if(_b80==0){
...
if(this._showingMore){
var _b83=new Number(this.levelInput.value).valueOf();
var _b84=new Number(this.lineInput.value).valueOf();
_b82=this._writeLevelClipping(_b83,_b84,_b82);
_b82=this._writeLineClipping(_b83,_b84,_b82);
}
}
}
}
...
this.selectedViewspecs.value=this._filterViewspecs(_b82);
},_writeLineClipping:function(_b85,_b86,_b87){
if(_b86==1){
_b87+="t";
}else{
if(_b86==hs.filter.ViewspecConstants.MAX_LINE_CLIPPING){
_b87+="s";
}else{
var _b88=hs.filter.ViewspecConstants.MAX_LINE_CLIPPING-_b86;
if(_b88<=_b86){
_b87+="s";
for(var i=_b88;i>0;i--){
_b87+="q";
}
}else{
_b87+="t";
...
return _b87;
},_writeLevelClipping:function(_b8a,_b8b,_b8c){
var _b8d=hs.ui.currentHyDoc.nodeCtxt.level;
if(_b8a==1){
_b8c+="d";
}else{
if(_b8a==hs.filter.ViewspecConstants.MAX_LEVEL_CLIPPING){
_b8c+="c";
}else{
if(_b8a==0){
_b8c+="da";
}else{
if(_b8a>=(hs.filter.ViewspecConstants.MAX_LEVEL_CLIPPING-20)){
_b8c+="c";
var _b8e=hs.filter.ViewspecConstants.MAX_LEVEL_CLIPPING-_b8a;
for(var i=_b8e;i>0;i--){
_b8c+="a";
}
}else{
if(_b8d!=0&&_b8a>=_b8d){
...
if(_b91>=_b8a){
_b8c+="d";
for(var i=2;i<=_b8a;i++){
_b8c+="b";
}
}else{
_b8c+="e";
for(var i=1;i<=_b91;i++){
_b8c+="a";
}
}
}else{
...
var _b94=hs.ui.currentHyDoc.currentViewspecs.toString();
_b93=_b94+_b93;
...
var _b95;
try{
_b95=new hs.filter.CurrentViewspecs(_b93,hs.ui.currentHyDoc);
}
catch(e){
evt.stopPropagation();
evt.preventDefault(true);
...
this._resetViewspecs(_b95);
},_filterViewspecs:function(_b96){
var _b97=this.selectedViewspecs.value;
var _b98;
if(this._showingMore){
_b98=/y|z|m|n|H|G|O|P|x|w|a|b|c|d|r|q|s|t|i|j|k/g;
}else{
_b98=/y|z|m|n|x|w/g;
}
_b97=_b97.replace(_b98,"");
_b96=_b96+_b97;
return _b96;
...
_b9a=this.viewTable.scrollHeight+50;
}else{
this._showingMore=false;
this.advancedButton.innerHTML="More&nbsp;&#9660;";
dojo.html.replaceClass(this.viewTable,"lessMode","moreMode");
_b9a=this._lessModeHeight;
}
var _b9b=dojo.widget.byId(this.widgetId+"Pane");
_b9b.resizeTo(_b99,_b9a);
},_markDirtyWithLetters:function(_b9c){
if(_b9c.indexOf("y")!=-1||_b9c.indexOf("z")!=-1){
this._blankLinesDirty=true;
}
if(_b9c.indexOf("m")!=-1||_b9c.indexOf("n")!=-1||_b9c.indexOf("G")!=-1||_b9c.indexOf("H")!=-1){
this._nodeAddressingDirty=true;
}
if(_b9c.indexOf("O")!=-1||_b9c.indexOf("P")!=-1){
this._includesOnDirty=true;
}
if(_b9c.indexOf("x")!=-1||_b9c.indexOf("w")!=-1||_b9c.indexOf("a")!=-1||_b9c.indexOf("b")!=-1||_b9c.indexOf("c")!=-1||_b9c.indexOf("d")!=-1||_b9c.indexOf("r")!=-1||_b9c.indexOf("q")!=-1||_b9c.indexOf("s")!=-1||_b9c.indexOf("t")!=-1||_b9c.indexOf("e")!=-1){
this._outlineDirty=true;
}
if(_b9c.indexOf("i")!=-1||_b9c.indexOf("j")!=-1||_b9c.indexOf("k")!=-1){
this._applyFilterDirty=true;
}
}});
...
this.width=dojo.style.getOuterWidth(this.domNode);
this.height=dojo.style.getOuterHeight(this.domNode);
var _b9d=this.height+50;
var _b9e=this.width;
this.jumpOverlay.style.width=_b9e+"px";
this.jumpOverlay.style.height=_b9d+"px";
...
var _ba1=dojo.widget.byId(this.widgetId+"Pane");
if(dojo.html.hasClass(_ba1.domNode,"initial-overlay-state")){
return false;
}else{
return _ba1.isShowing();
}
},show:function(){
hs.ui.markingMode=true;
this.addressInput.value="";
var _ba2=dojo.widget.byId(this.widgetId+"Pane");
_ba2.bringToTop();
dojo.html.removeClass(_ba2.domNode,"initial-overlay-state");
var _ba3=dojo.byId("toolbarJumpButton");
var _ba4=dojo.html.getOuterWidth(_ba3);
var _ba5=dojo.html.getViewportWidth();
var _ba6=dojo.style.getAbsoluteY(_ba3,false)+_ba4/2;
var _ba7=dojo.html.getOuterHeight(dojo.byId("toolbar"));
var endY=_ba7+30;
if(dojo.render.html.ie!=true){
dojo.style.setOpacity(_ba2.domNode,0);
}
dojo.style.show(_ba2.domNode);
var _ba9=new Array();
if(dojo.render.html.ie!=true){
_ba9.push({property:"opacity",start:0,end:1});
}
_ba9.push({property:"right",start:60,end:60});
_ba9.push({property:"top",start:_ba6,end:endY});
var anim=dojo.lfx.propertyAnimation(_ba2.domNode,_ba9,250);
dojo.event.connect(anim,"onEnd",dojo.lang.hitch(this,function(){
...
var _bab=dojo.widget.byId(this.widgetId+"Pane");
var _bac=dojo.html.getViewportWidth();
var _bad=dojo.html.getOuterHeight(dojo.byId("toolbar"));
var _bae=_bad+30;
var _baf=dojo.byId("toolbarJumpButton");
var _bb0=dojo.html.getOuterWidth(_baf);
var endY=dojo.style.getAbsoluteY(_baf,false)+_bb0/2;
var _bb2=new Array();
if(dojo.render.html.ie!=true){
_bb2.push({property:"opacity",start:1,end:0});
}
_bb2.push({property:"right",start:60,end:60});
_bb2.push({property:"top",start:_bae,end:endY});
var anim=dojo.lfx.propertyAnimation(_bab.domNode,_bb2,250);
dojo.event.connect(anim,"onEnd",function(){
dojo.style.hide(_bab.domNode);
});
anim.play();
},_setMarkable:function(_bb4){
if(_bb4==true){
if(this._mark!=null){
...
var _bb9=this._buttonStates[i];
_bb9.domNode.src=_bb9.normal;
dojo.event.connect(_bb9.domNode,"onmouseup",this,"_handleMouse");
dojo.event.connect(_bb9.domNode,"onmousedown",this,"_handleMouse");
dojo.event.connect(_bb9.domNode,"onmouseover",this,"_handleMouse");
dojo.event.connect(_bb9.domNode,"onmouseout",this,"_handleMouse");
dojo.event.connect(_bb9.domNode,"onclick",this,"_handleMouse");
}
...
_bbd=this._buttonStates[i];
break;
}
}
switch(evt.type.toLowerCase()){
case "mouseover":
_bbd.domNode.src=_bbd.rollover;
break;
case "mouseout":
_bbd.domNode.src=_bbd.normal;
break;
case "mousedown":
_bbd.domNode.src=_bbd.down;
break;
case "mouseup":
_bbd.domNode.src=_bbd.rollover;
break;
...
var _bbf=dojo.widget.byId("jumpOverlay");
if(_bbf.isShowing()==true){
_bbf.hide();
}else{
_bbf.show();
}
},_toggleViewspecsOverlay:function(){
var _bc0=dojo.widget.byId("viewspecsOverlay");
if(_bc0.isShowing()==true){
_bc0.hide();
}else{
_bc0.show();
}
},_toggleCommandBar:function(_bc1){
if(hs.ui.commandBar.isShowing()||_bc1==false){
...
var _bc2=dojo.widget.byId("jumpOverlay");
var _bc3=dojo.widget.byId("viewspecsOverlay");
...
var _bc5=dojo.io.cookie.get("isturbomode");
if(_bc5=="yes"){
return true;
}else{
return false;
...
var _bc6=dojo.widget.byId("helpOverlay");
if(_bc6.isShowing()==true){
_bc6.hide();
}else{
_bc6.show();
}
}});
hs.ui.ResultWriter=function(_bc7,_bc8,_bc9){
this._renderDoc=_bc7;
this._onFinishedWriting=_bc9;
this._iframe=_bc8;
this._initializeIframe();
this._lineClipper=new hs.ui.LineClipper(_bc8);
};
...
_bcc=doc.renderedHtmlDom.selectNodes("//*[@id='hyperScopeDocument']")[0];
}else{
_bcc=doc.renderedHtmlDom.getElementById("hyperScopeDocument");
}
this._trNodes=_bcc.childNodes;
_bcb.body.innerHTML="";
var _bcd;
if(typeof _bcb.importNode=="undefined"){
var _bce=_bcb.createElement("table");
_bce.id="hyperScopeDocument";
_bce.className=_bcc.getAttribute("class");
var _bcf=_bcb.createElement("tbody");
_bce.appendChild(_bcf);
_bcb.body.appendChild(_bce);
_bcd=_bcf;
}else{
_bcd=_bcb.importNode(_bcc,false);
_bcb.body.appendChild(_bcd);
_bcd=_bcb.getElementById("hyperScopeDocument");
}
this._container=_bcd;
...
var _bd0=this._iframe.createElement("div");
_bd0.className="nothing-to-show-message";
_bd0.innerHTML="The combination of content filter and "+"viewspecs produces nothing to display; "+"<a href=\"#:j\">click here</a> to turn "+"the content filter off and display "+"content again";
this._iframe.body.appendChild(_bd0);
}
...
var _bd1=hs.ui.ResultWriter._CHUNK_AMOUNT;
var _bd2=this._trNodes;
var _bd3=this._currentIndex;
var _bd4=this._iframe;
var _bd5=this._container;
var _bd6=new Array();
var _bd7=this._applyFilter;
if(typeof _bd4.importNode!="undefined"){
var _bd8=_bd4.createDocumentFragment();
for(var _bd9=0;_bd9<_bd1&&_bd3<_bd2.length;_bd9++,_bd3++){
var row=_bd4.importNode(_bd2[_bd3],true);
if(_bd7==true&&row.getAttribute(hs.model.Document.HS_INTERNAL_NAMESPACE_PREFIX+":passes-content-filter")!="yes"){
continue;
}
this._haveOneFilteredNode=true;
var _bdb=row.childNodes[1].firstChild.childNodes[1];
var data=_bdb.innerHTML;
var _bdd=false;
if(data.indexOf("&")!=-1){
data=data.replace(/&lt;/g,"<");
data=data.replace(/&gt;/g,">");
...
_bd8.appendChild(row);
_bd6[_bd6.length]=row;
}
this._currentIndex=_bd3;
_bd5.appendChild(_bd8);
}else{
var _bd8=_bd4.createElement("div");
var html=new String();
for(var _bd9=0;_bd9<_bd1&&_bd3<_bd2.length;_bd9++,_bd3++){
html+=_bd2[_bd3].xml;
}
this._currentIndex=_bd3;
_bd8.innerHTML="<table><tbody>"+html+"</tbody></table>";
var _bdf=_bd8.getElementsByTagName("tbody")[0];
var rows=_bdf.getElementsByTagName("tr");
...
this._haveOneFilteredNode=true;
_bd5.appendChild(row);
_bd6[_bd6.length]=row;
}
}
this._renderDoc.focusContextNode();
this._lineClipper.applyChunk(this._doc,_bd5,_bd6);
}
},_padBottomOfDocument:function(){
var _be2=this._iframe;
var _be3=dojo.style.getOuterHeight(_be2.body);
var _be4=_be2.createElement("div");
_be4.style.height=_be3+"px";
_be2.body.appendChild(_be4);
...
this.row=tg;
var _bea=this.row.getAttribute(hs.model.Document.HS_INTERNAL_NAMESPACE_PREFIX+":number");
var url="#"+_bea;
try{
...
hs.ui.LineClipper=function(_bec){
this._iframeDoc=_bec;
this._standardLineHeight=this._computeLineHeight(_bec);
};
dojo.lang.extend(hs.ui.LineClipper,{_iframeDoc:null,_standardLineHeight:null,_containerRegExp:new RegExp("^h[1-6]|div|span|ul|ol|li|textarea"+"|form|p|pre|blockquote|address|td$","i"),applyChunk:function(doc,_bee,_bef){
var _bf0=doc.currentViewspecs.getLineClipping();
if(_bf0==hs.filter.ViewspecConstants.MAX_LINE_CLIPPING){
return;
}
var _bf1=_bef.length;
var _bf2=this._containerRegExp;
var _bf3=this._standardLineHeight;
var _bf4=this._iframeDoc;
var row,dataCell,dataContainer,firstElement;
var _bf6,dataHeight,heightOfOneLine;
var _bf7,heightClassName,heightEntry;
var img,currentViews,containerElem;
for(var i=0;i<_bf1;i++){
row=_bef[i];
...
if(containerElem!=null&&containerElem.nodeType==dojo.dom.ELEMENT_NODE&&_bf2.test(containerElem.nodeName)==true){
firstElement=containerElem;
}
heightOfOneLine=this._computeLineHeight(_bf4,firstElement);
}else{
heightOfOneLine=_bf3;
}
_bf7=heightOfOneLine*_bf0;
if(_bf7>dataHeight){
_bf7=dataHeight;
}
dataContainer.style.height=_bf7+"px";
if(dojo.render.html.mozilla&&_bf6&&firstElement.firstChild&&firstElement.firstChild.nodeName.toLowerCase()=="img"){
...
},_computeLineHeight:function(_bfa,node){
var _bfc;
if(node!=null&&typeof node!="undefined"){
_bfc=node.cloneNode(false);
}else{
_bfc=_bfa.createElement("div");
}
_bfc.style.margin="0px";
_bfc.style.padding="0px";
_bfc.style.border="0px";
_bfc.style.visibility="hidden";
var _bfd="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz";
_bfc.innerHTML=_bfd;
_bfa.body.appendChild(_bfc);
var _bfe=_bfc.scrollHeight;
dojo.dom.removeNode(_bfc);
return _bfe;
}});
...
var _c00=this._inputBuffer[i];
if(_c00.mark!=null){
this._setMarkable(false,_c00.mark);
}
}
...
this.reset();
var _c01=dojo.byId("commandBar");
_c01.style.visibility="visible";
this.visible=true;
},hide:function(){
var _c02=dojo.byId("commandBar");
_c02.style.visibility="hidden";
this.visible=false;
},_loadCommandXML:function(){
var _c03={url:hs.ui.CommandBar._COMMAND_FILE,sync:djConfig.testing,mimetype:"text/xml",error:dojo.lang.hitch(this,this._error),load:dojo.lang.hitch(this,this._loaded)};
dojo.io.bind(_c03);
},_error:function(type,_c05){
var _c06=_c05.message;
if(_c06.indexOf("XMLHttpTransport Error:")!=-1){
_c06=_c06.replace(/XMLHttpTransport Error:/,"");
}
hs.ui.reportError("Unable to initialize command bar: "+_c06);
},_loaded:function(type,data,evt){
var _c0a=data.selectNodes("/commands/subsystem[@id = 'base-subsystem']");
this._commands=_c0a.item(0);
...
this._ready=true;
this.reset();
},_onRenderedDocument:function(_c0b){
dojo.event.disconnect(_c0b,"onkeypress",this,this._onKey);
dojo.event.connect(_c0b,"onkeypress",this,this._onKey);
if(dojo.render.html.ie){
dojo.event.disconnect(_c0b,"onkeydown",this,this._handleBackspace);
dojo.event.connect(_c0b,"onkeydown",this,this._handleBackspace);
}
},_setOutput:function(msg){
var _c0d=this._outputArea.childNodes;
for(var i=0;i<_c0d.length;i++){
dojo.dom.removeNode(_c0d[i]);
}
...
var _c11=new Array();
for(var i=0;i<this._inputBuffer.length;i++){
_c11[_c11.length]=this._inputBuffer[i];
}
_c10+=this._commands.getAttribute("output")+" ";
if(_c11.length==0){
_c10+="C: ";
}
...
_c10=this._handleLanguageElement(_c11,_c10,this._commands.childNodes,this._states.VERB);
}else{
if(this._currentState==this._states.VERB||this._currentState==this._states.NOUN){
_c10=this._handleLanguageElement(_c11,_c10,this._languageElement.childNodes,this._states.NOUN);
if(typeof this._languageElement!="undefined"&&this._languageElement!=null&&this._needsInput(this._languageElement)==true){
_c10=this._selectInput(_c11,_c10,this._languageElement);
}
}else{
if(this._currentState==this._states.INPUT){
_c10=this._consumeInput(_c11,_c10);
}
}
}
if(this._currentState==this._states.METHOD){
this._setOutput(_c10);
this._executeMethod();
return;
}
}
...
},_handleLanguageElement:function(_c13,_c14,_c15,_c16){
var _c17=new String();
var _c18=false;
var _c19=false;
while(_c18==false&&_c13.length!=0){
_c19=false;
var _c1a=_c13.shift();
var _c1b=_c1a.value;
_c1b=_c1b.toLowerCase();
_c17+=_c1b;
for(var i=0;i<_c15.length;i++){
var elem=_c15[i];
if(elem.nodeType!=dojo.dom.ELEMENT_NODE){
continue;
}
var _c1e=elem.getAttribute("activate");
if(_c17==_c1e){
this._languageElement=elem;
_c18=true;
break;
}else{
if(dojo.string.startsWith(_c1e,_c17,true)){
_c19=true;
break;
}
}
}
if(_c19==false&&_c18==false){
...
if(_c19==true&&_c18==false){
_c17=_c17.toUpperCase();
_c14+=_c17;
return _c14;
}
var _c1f=this._languageElement.getAttribute("output");
_c14+=_c1f;
this._currentState=_c16;
if(this._nestedNoun(this._languageElement)==true&&_c13.length==0){
_c14+="C: ";
}
return _c14;
},_needsInput:function(_c20){
if(_c20==null||typeof _c20=="undefined"||_c20.childNodes==null||typeof _c20.childNodes=="undefined"||_c20.childNodes.length==0){
return false;
}
var _c21=_c20.firstChild;
while(_c21!=null&&_c21.nodeType!=dojo.dom.ELEMENT_NODE){
_c21=_c21.nextSibling;
}
if(_c21==null){
return false;
}
if(_c21.nodeName=="input"){
return true;
}else{
return false;
}
},_selectInput:function(_c22,_c23,_c24,_c25){
if(typeof _c25=="undefined"){
_c25=false;
}
var _c26;
if(_c25==false){
_c26=_c24.firstChild;
while(_c26!=null&&_c26.nodeType!=dojo.dom.ELEMENT_NODE&&_c26.nodeName!="input"){
_c26=_c26.nextSibling;
}
}else{
_c26=_c24;
}
var _c27=_c26.getAttribute("type");
...
if(_c27=="persisted typein"){
if(this._persistedValue!=null&&this._firstPersist==false){
_c23+="\""+this._persistedValue+"\" RC/T: ";
}else{
_c23+="T: ";
}
hs.ui.markingMode=false;
...
this._languageElement=_c26;
this._inputType=_c27;
return _c23;
},_consumeInput:function(_c28,_c29){
if(this._currentState==this._states.DONE){
return;
}
var _c2a=_c28.shift();
...
if(_c2a.mark!=null){
_c29+=" ! ";
this._mark=_c2a.mark;
this._interpretInput();
_c2b=true;
_c2c=true;
}else{
if(this._persistedValue!=null&&_c2a.isEnter==true&&this._inputType=="persisted typein"&&this._inputText.length==0){
this._inputText=this._persistedValue;
_c29+=" ! ";
this._interpretInput();
_c2b=true;
}else{
if(_c2a.isEnter==true){
_c29+=" ! ";
this._interpretInput();
_c2b=true;
}else{
if(this._persistedValue!=null&&_c2a.isRepeatKey==true&&this._inputType=="persisted typein"){
this._inputText=this._persistedValue;
_c29+=" ! ";
this._interpretInput();
_c2b=true;
...
var _c2d=_c2a.value;
_c29+=_c2d;
this._inputText+=_c2d;
}
}
}
}
if(_c2b==true&&this._currentState!=this._states.DONE){
if(_c2c==true&&this._needsInput(this._languageElement)==false&&this._atMethod(this._languageElement)==true){
var _c2e=this._languageElement.cloneNode(true);
_c2e.setAttribute("type","ok");
this._languageElement=_c2e;
this._currentState=this._states.INPUT;
_c29=this._selectInput(_c28,_c29,this._languageElement,true);
}else{
if(this._needsInput(this._languageElement)==true){
_c29=this._selectInput(_c28,_c29,this._languageElement);
}else{
...
return _c29;
},_getMethod:function(_c2f){
var _c30=_c2f.firstChild;
while(_c30!=null&&_c30.nodeType!=dojo.dom.ELEMENT_NODE&&_c30.nodeName!="method"){
_c30=_c30.nextSibling;
}
return _c30;
},_atMethod:function(_c31){
if(_c31==null||typeof _c31=="undefined"||_c31.childNodes==null||typeof _c31.childNodes=="undefined"||_c31.childNodes.length==0){
return false;
}
var _c32=_c31.firstChild;
while(_c32!=null&&_c32.nodeType!=dojo.dom.ELEMENT_NODE){
_c32=_c32.nextSibling;
}
if(_c32==null){
return false;
}
if(_c32.nodeName=="method"){
return true;
}else{
return false;
}
...
},_nestedNoun:function(_c37){
if(_c37==null||typeof _c37=="undefined"||_c37.childNodes==null||typeof _c37.childNodes=="undefined"||_c37.childNodes.length==0){
return false;
}
var _c38=_c37.firstChild;
while(_c38!=null&&_c38.nodeType!=dojo.dom.ELEMENT_NODE){
_c38=_c38.nextSibling;
}
if(_c38==null){
return false;
}
if(_c38.nodeName=="noun"){
return true;
}else{
return false;
}
...
var _c3c=new Object();
_c3c.mark=null;
_c3c.isRepeatKey=false;
if(evt.keyCode==13){
_c3c.isEnter=true;
_c3c.value=null;
this._inputBuffer[this._inputBuffer.length]=_c3c;
}else{
if(evt.keyCode==27){
this.reset();
return;
...
if(evt.keyCode==8){
var _c3d=this._inputBuffer[this._inputBuffer.length-1];
if(_c3d!=null&&typeof _c3d!="undefined"&&_c3d.mark!=null){
this._setMarkable(false,_c3d.mark);
}
...
_c3c.isEnter=false;
_c3c.value=String.fromCharCode(evt.charCode);
this._inputBuffer[this._inputBuffer.length]=_c3c;
}
}
}
...
},_setMarkable:function(_c3f,mark){
if(hs.ui.markingMode==true){
if(mark!=null){
...
var _c43=null;
for(var i=0;i<this._inputBuffer.length;i++){
var _c45=this._inputBuffer[i];
if(_c45.mark!=null&&typeof _c45.mark!="undefined"){
_c43=_c45.mark;
}
}
this._setMarkable(false,_c43);
var _c45=new Object();
_c45.mark=mark;
_c45.isEnter=false;
_c45.value=null;
this._inputBuffer[this._inputBuffer.length]=_c45;
...
var _c46=dojo.widget.byId(this.widgetId+"Pane");
if(dojo.html.hasClass(_c46.domNode,"initial-overlay-state")){
return false;
}else{
return _c46.isShowing();
}
},show:function(){
var _c47=dojo.widget.byId(this.widgetId+"Pane");
_c47.bringToTop();
_c47.closeWindow=this._closeWindow;
dojo.html.removeClass(_c47.domNode,"initial-overlay-state");
var _c48=dojo.byId("toolbarHelpButton");
var _c49=dojo.html.getOuterWidth(_c48);
var _c4a=dojo.html.getViewportWidth();
var _c4b=dojo.style.getAbsoluteY(_c48,false)+_c49/2;
var _c4c=dojo.html.getOuterHeight(dojo.byId("toolbar"));
var endY=_c4c+30;
if(dojo.render.html.ie!=true){
dojo.style.setOpacity(_c47.domNode,0);
}
dojo.style.show(_c47.domNode);
var _c4e=new Array();
if(dojo.render.html.ie!=true){
_c4e.push({property:"opacity",start:0,end:1});
}
_c4e.push({property:"left",start:20,end:20});
_c4e.push({property:"top",start:_c4b,end:endY});
var anim=dojo.lfx.propertyAnimation(_c47.domNode,_c4e,250);
anim.play();
},hide:function(){
var _c50=dojo.widget.byId(this.widgetId+"Pane");
var _c51=dojo.html.getViewportWidth();
var _c52=dojo.html.getOuterHeight(dojo.byId("toolbar"));
var _c53=_c52+30;
var _c54=dojo.byId("toolbarHelpButton");
var _c55=dojo.html.getOuterWidth(_c54);
var endY=dojo.style.getAbsoluteY(_c54,false)+_c55/2;
var _c57=new Array();
if(dojo.render.html.ie!=true){
_c57.push({property:"opacity",start:1,end:0});
}
_c57.push({property:"right",start:20,end:20});
_c57.push({property:"top",start:_c53,end:endY});
var anim=dojo.lfx.propertyAnimation(_c50.domNode,_c57,250);
dojo.event.connect(anim,"onEnd",function(){
dojo.style.hide(_c50.domNode);
});
anim.play();
