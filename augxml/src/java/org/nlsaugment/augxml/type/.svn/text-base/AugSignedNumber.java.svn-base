...
/**
 * The AugSignedNumber class stores signed integer values.
 * The implementation only holds Integer values [Integer.MIN_VALUE, Integer.MAX_VALUE].
 ...
 *
 */
public final class AugSignedNumber extends AugType {
  public AugSignedNumber(final MemorySpace memorySpace, final Location location, final int numBits) {
  ...
  public Integer getValue() {
    return getBits().toSignedInteger();
  }
}
